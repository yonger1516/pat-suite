...
PARAMS=""
PARAMS="$PARAMS -Ddfs.replication=1"
...
PARAMS="$PARAMS -Dmapreduce.map.memory.mb=2300"
PARAMS="$PARAMS -Dmapreduce.map.java.opts=-Xmx1600m"
...
#PARAMS="$PARAMS -Dmapreduce.reduce.java.opts=-Xmx2750m"
...
PARAMS="$PARAMS -Dmapreduce.job.maps=62"
#62*6= 100GB/256MB

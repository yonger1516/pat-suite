...
shoot(){
        ...
        cp -r $HIBENCH_BASE/report/terasort/spark/scala $HIBENCH_BASE/../result/$tempdir
...
run_spark_terasort(){
        workload_folder=$HIBENCH_BASE/workloads/terasort/spark/scala/bin
...
#	sed -i -e "s/^hibench.default.shuffle.parallelism.*/hibench.default.shuffle.parallelism $2/" $HIBENCH_BASE/conf/99-user_defined_properties.conf
	sed -i -e "s/^hibench.yarn.executor.num.*/hibench.yarn.executor.num $2/" $HIBENCH_BASE/conf/99-user_defined_properties.conf
	sed -i -e "s/^hibench.yarn.executor.cores.*/hibench.yarn.executor.cores $3/" $HIBENCH_BASE/conf/99-user_defined_properties.conf
	sed -i -e "s/^spark.executor.memory.*/spark.executor.memory $4/" $HIBENCH_BASE/conf/99-user_defined_properties.conf
...
#changePara 1615 1615 81 5 11g
#changePara 1795 1795 90 5 10400m
#changePara 1795 1795 90 6 10400m
#changePara 1935 1935 81 6 12g 
#changePara 800 99 5 10100m
changePara 80 12 5 12000m
#changePara 800 72 5 13500m
#changePara 800 63 5 15500m
#changePara 800 54 5 18000m
#changePara 800 36 5 25g
#changePara 800 81 5 11g
#changePara 3140 3140 126 5 7430m
shoot
